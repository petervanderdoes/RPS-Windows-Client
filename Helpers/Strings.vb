Namespace Helpers
    Public Class Strings
        ...
        ''' <remarks>
        '''     Trims the trailing slash off a string if it exists.  The primary use for this is validating file folder paths, i.e.
        '''     changing "C:\Temp\" to "C:\Temp"
        ''' </remarks>
        ''' <returns>String</returns>
        ''' <example>
        '''     MsgBox(TrimTrailingSlash("C:\Windows\Temp\"))
        ''' </example>
        Public Shared Function trimTrailingSlash(input_string As String) As String
            'trim any blanks
